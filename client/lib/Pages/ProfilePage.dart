            ...
            Container(
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    Color.fromARGB(255, 41, 88, 190),
                    Color.fromARGB(255, 185, 55, 142)
                  ],
                ...
                children: <Widget>[
                  ListTile(
                    title: Text(
                      'Phone No',
                      style: TextStyle(
                        color: Color.fromARGB(255, 72, 113, 226),
                        fontSize: 20,
                        fontWeight: FontWeight.bold,
                      ),
                    ),
                    subtitle: Text(
                      '${context.read<Profile>().data['phoneNo']}',
                      // '987654321',
                      style: TextStyle(
                        fontSize: 18,
                      ),
                  ...
                  ListTile(
                    ...
                    subtitle: Text(
                      '${context.read<Profile>().data['emailId']}',
                      style: TextStyle(
                        fontSize: 18,
                      ),
                    ),
